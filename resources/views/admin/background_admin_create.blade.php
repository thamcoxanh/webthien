                                ...
                                <ul id="images">
                                    @for($i=0 ; $i<50 ; $i++)
                                     <li @if ($i >=2) class="hidden" @endif >
                                            <input class="input_image" type="hidden" id="chooseImage_input{{ $i }}" name="data[images][{{ $i }}][url]" value="">
                                            ...
                                            <br/>
                                            Width :
                                            <input class="input_image" type="text" id="chooseImage_input{{ $i }}" name="data[images][{{ $i }}][width]" value="">

                                            Height :
                                            <input class="input_image" type="text" id="chooseImage_input{{ $i }}" name="data[images][{{ $i }}][height]" value="">
