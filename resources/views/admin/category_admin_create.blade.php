...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <form action="/admin/category-create" method="get" id="update-form">
          <div class="card">
              <div class="header">
                  <h2>
                      Category Advanced
                    ...
                    <div class="form-line">
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <textarea rows="4" name="data[description]" value="{{ @$data['description'] }}" class="form-control no-resize" placeholder="Please description what you want..."></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    function update_confirm(id){
        ...
        var r = confirm("Do you want insert this Category ?");
        if (r == true) {
            $('#update-form').submit();
        }
